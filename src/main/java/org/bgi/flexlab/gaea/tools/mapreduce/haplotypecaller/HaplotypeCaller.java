...
public class HaplotypeCaller extends ToolsRunner {
    ...
    public HaplotypeCaller() {
        this.toolsDescription = "Gaea haplotypecaller";
    }

    private HaplotypeCallerOptions options = null;

    private int runHaplotypeCaller(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        BioJob job = BioJob.getInstance();
        Configuration conf = job.getConfiguration();
        String[] remainArgs = remainArgs(args, conf);

        options = new HaplotypeCallerOptions();
        ...
        job.setJobName("GaeaHaplotypeCaller");
    ...
    public int run(String[] args) throws Exception {
        HaplotypeCaller genotyper = new HaplotypeCaller();
        int res = genotyper.runHaplotypeCaller(args);
