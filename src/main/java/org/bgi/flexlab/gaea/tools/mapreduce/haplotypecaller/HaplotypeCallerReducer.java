 ...
 */
public class HaplotypeCallerReducer extends Reducer<WindowsBasedWritable, AlignmentBasicWritable, NullWritable, VariantContextWritable>{
    /**
     * options
     */
    ...
    protected void setup(Context context) throws IOException {
        ...
        engine = new HaplotypeCallerEngine(options, header);
